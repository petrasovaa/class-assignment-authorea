These are the steps to use Authorea and Gitub together:
...
As you can see when you look into the history of my repository, as I type, changes are pushed to GitHub.
