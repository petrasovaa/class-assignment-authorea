It is often very useful to edit a document offline, for example in a plane, or if you want to think your changes through and These are the steps to use Authorea and GitHub together:
